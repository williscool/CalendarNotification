        ...
        if (isEmpty) {
            ...
            val message = when {
                hasSearch && hasFilter -> {
                    ...
                    getString(R.string.empty_dismissed_with_search_and_filters, searchQuery, filterDesc)
                }
                hasSearch -> getString(R.string.empty_dismissed_with_search, searchQuery)
                hasFilter -> {
                    val filterDesc = filterState.toDisplayString(requireContext()) ?: ""
                    getString(R.string.empty_dismissed_with_filters, filterDesc)
                }
                else -> baseMessage
            }

...
fun DismissedEventAlertRecord.formatReason(ctx: Context): String =
        when (this.dismissType) {
            ...
            EventDismissType.ManuallyDismissedFromActivity ->
                String.format(ctx.resources.getString(R.string.dismissed_from_active), dateToStr(ctx, this.dismissTime))

            EventDismissType.ManuallyDismissedFromUpcoming ->
                String.format(ctx.resources.getString(R.string.dismissed_from_upcoming), dateToStr(ctx, this.dismissTime))

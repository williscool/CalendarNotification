...
class MaxNotificationsPreferenceX @JvmOverloads constructor(
    context: Context,
    ...
    var value: Int = Consts.DEFAULT_NOTIFICATIONS
        private set
    ...
    override fun onSetInitialValue(defaultValue: Any?) {
        value = getPersistedInt((defaultValue as? Int) ?: Consts.DEFAULT_NOTIFICATIONS)
    }
    ...
    class Dialog : PreferenceDialogFragmentCompat() {
        ...
        override fun onBindDialogView(view: View) {
            ...
            val pref = preference as MaxNotificationsPreferenceX
